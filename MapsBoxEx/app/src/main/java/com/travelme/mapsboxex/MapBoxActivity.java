...
public class MapBoxActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.moveCamera(CameraUpdateFactory.newLatLngZoom(tegal, 8.5f));
    ...
    public void onPermissionResult(boolean granted) {
        if (granted) {
            ...
            Toast.makeText(this, "User tidak ada", Toast.LENGTH_LONG).show();
            finish();
        }
    }
        ...
        findViewById(R.id.fab_location_search).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new PlaceAutocomplete.IntentBuilder()
                        .accessToken(Mapbox.getAccessToken() != null ? Mapbox.getAccessToken() : getString(R.string.map_box_access_token))
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == REQUEST_CODE_AUTOCOMPLETE) {
            ...
            toasy(selectedCarmenFeature.placeName());
            if (mapboxMap != null) {
    ...
    private void toasy(String message) {
